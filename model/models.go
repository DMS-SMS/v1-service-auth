...
type StudentAuth struct {
	...
	StudentId  string `gorm:"Type:varchar(20);NOT NULL;UNIQUE" validate:"min=4,max=20,ascii"`        // 4~20자 사이
...
type TeacherAuth struct {
	...
	TeacherId string `gorm:"varchar(20);NOT NULL;UNIQUE" validate:"min=4,max=20,ascii"`             // 4~20자 사이
...
type ParentAuth struct {
	...
	ParentId string `gorm:"Type:varchar(20);NOT NULL;UNIQUE" validate:"min=4,max=20,ascii"`       // 4~20자 사이
